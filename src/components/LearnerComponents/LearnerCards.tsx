...
import LearnerUpdate from "../../screen/LearnerScreens/LearnerEditScreen";
import LearnerDelete from "../../screen/LearnerScreens/LearnerDeleteScreen";
...
const LearnerCard: React.FC<Props> = ({ data }) => {
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.title}>
        <Text style={{ color: "#545C63" }}>Id:</Text> {data.id_learner}
      </Text>
      <Text style={styles.title}>
        <Text style={{ color: "#545C63" }}>First Name:</Text> {data.first_name}
      </Text>
      <Text style={styles.title}>
        <Text style={{ color: "#545C63" }}>Last Name:</Text> {data.last_name}
      </Text>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text>{data.id_learner}</Text>
            <LearnerDelete
              id_learner={data.id_learner}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <LearnerUpdate
              id_learner={Number(data.id_learner)}
